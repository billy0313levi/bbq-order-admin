	...
	export default {
		data() {
			...
			return {
				...
				table1: {
					// 表格数据请求地址
					action: "admin/object/sys.guestSeat.kh_getList",
					// 表格字段显示规则
					columns: [{
							key: "imageUrl",
							title: "二维码",
		...
		methods: {
			...
			addBtn() {
				that.resetForm();
				that.form1.props.action = 'admin/object/sys.guestSeat.add';
			...
			updateBtn({
				...
				that.form1.props.action = 'admin/object/sys.guestSeat.edit';
			...
			deleteBtn({
				...
				deleteFn({
					action: "admin/object/sys.guestSeat.del",
					data: {
						_id: item._id
					},
				});
