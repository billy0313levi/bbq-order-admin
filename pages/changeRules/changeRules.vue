	...
	export default {
		data() {
			...
			return {
				...
				table1: {
					// 表格数据请求地址
					action: "admin/object/sys.changeRules.kh_getList",
					// 表格字段显示规则
					columns: [{
							key: "recharge",
							title: "充值金额",
		...
		methods: {
			...
			addBtn() {
				that.resetForm();
				that.form1.props.action = 'admin/object/sys.changeRules.add';
			...
			updateBtn({
				...
				that.form1.props.action = 'admin/object/sys.changeRules.edit';
			...
			deleteBtn({
				...
				deleteFn({
					action: "admin/object/sys.changeRules.del",
					data: {
						_id: item._id
					},
				});
