  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("categoryName,name,categoryLogo,icon,sort,delivery,status,_add_time,_add_time_str,_update_time,_update_time_str").get().then((res) => {
