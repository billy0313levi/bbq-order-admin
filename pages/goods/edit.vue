  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("goodsName,name,goodsLogo,goodsLogos,img,imgs,price,categoryId,category_id,content,desc,sort,stock,delivery,status,start,salesVolume,isVip,rate,spec_list,sku_list,uid,_add_time,_add_time_str,_update_time,_update_time_str").get().then((res) => {
