<template>
	<view class="page-body">
		...
		<vk-data-table ref="table1" :action="table1.action" :columns="table1.columns" :query-form-param="queryForm1"
			:right-btns="['update','delete']" :selection="true" :row-no="true" :pagination="true" @update="updateBtn"
	...
	export default {
		data() {
			...
			return {
				...
				table1: {
					// 表格数据请求地址
					action: "admin/object/sys.notice.kh_getList",
					// 表格字段显示规则
					columns: [{
							key: "_id",
							title: "id",
		...
		methods: {
			...
			addBtn() {
				that.resetForm();
				that.form1.props.action = 'admin/object/sys.notice.add';
			...
			updateBtn({
				...
				that.form1.props.action = 'admin/object/sys.notice.edit';
			...
			deleteBtn({
				...
				deleteFn({
					action: "admin/object/sys.notice.del",
					data: {
						_id: item._id
					},
				});
