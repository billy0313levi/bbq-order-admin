  ...
  async generate(tableNo, capacity = 4) {
    ...
    try {
      ...
      if (exist) {
        ...
        return {
          code: 0,
          data: { _id: exist._id, tableNo, qrcodeImg: tempURL, qrcodeImgFileID: fileID, qrcodeUrl: scene },
          msg: '小程序码已更新'
        };
      }
      ...
      return {
        code: 0,
        data: { _id: addRes.id, tableNo, qrcodeImg: tempURL, qrcodeImgFileID: fileID, qrcodeUrl: scene },
        msg: '小程序码生成成功'
      };
    } catch (e) {
